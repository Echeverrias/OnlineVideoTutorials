...
public class ParticipantSessionTest {
    ...
    public void setUpBefore() {
        this.participant = ParticipantSessionDispenser.getStudentParticipant((String)"angela.gossow", (MediaPipeline)ParticipantSessionDispenser.PIPELINE_ROOM_TEST);
    }

    @Test
    public void receivesGreetingsFromTest() {
        ParticipantSession participant2 = ParticipantSessionDispenser.getStudentParticipant((String)"doro.pesch", (MediaPipeline)ParticipantSessionDispenser.PIPELINE_ROOM_TEST);
