...
public class UserControllerTest {
    ...
    public void user_validate_ok_test() {
        ...
        try {
            this.mockMvc.perform((RequestBuilder)MockMvcRequestBuilders.post((String)"/validateUser", (Object[])new Object[0]).contentType("application/json").content(new ObjectMapper().writeValueAsString((Object)request))).andExpect(MockMvcResultMatchers.status().isOk()).andExpect(MockMvcResultMatchers.jsonPath((String)"$.userName", (Object[])new Object[0]).value((Object)user.getUserName())).andExpect(MockMvcResultMatchers.jsonPath((String)"$.userType", (Object[])new Object[0]).value((Object)user.getUserType())).andExpect(MockMvcResultMatchers.jsonPath((String)"$.name", (Object[])new Object[0]).value((Object)user.getName())).andExpect(MockMvcResultMatchers.jsonPath((String)"$.password", (Object[])new Object[0]).doesNotExist());
        }
        catch (Exception e) {
    ...
    public void user_validate_not_found_test() {
        ...
        try {
            this.mockMvc.perform((RequestBuilder)MockMvcRequestBuilders.post((String)"/validateUser", (Object[])new Object[0]).contentType("application/json").content(new ObjectMapper().writeValueAsString((Object)request))).andExpect(MockMvcResultMatchers.status().isNotFound()).andExpect(MockMvcResultMatchers.jsonPath((String)"$", (Object[])new Object[0]).doesNotExist());
        }
        catch (Exception e) {
            ((UserSessionsRegistry)Mockito.verify((Object)this.usersRegistry, (VerificationMode)Mockito.times((int)1))).isThereAlreadyThisUser(request.getUserName());
            ((UserRepository)Mockito.verify((Object)this.userRepository, (VerificationMode)Mockito.times((int)1))).findByUserName(request.getUserName());
