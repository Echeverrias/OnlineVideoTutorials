...
var RoomDetailsComponent = (function () {
    function RoomDetailsComponent() {
        ...
        this.validMimeTypes = contentDisplayer_component_1.ContentDisplayerComponent.getValidMimeTypes();
        console.log("/ RoomDetailsComponent constructor " + new Date().toLocaleTimeString());
        console.log("");
    }
  ...
  */
    RoomDetailsComponent.prototype.onLoadFile = function (fileUrl) {
        console.log("RoomDetailsComponent.onLoadFile({{fileUrl}})");
        this.displayedFile = fileUrl;
    };
    RoomDetailsComponent.prototype.onCloseContentDisplayer = function (close) {
