...
var HistoryService = (function () {
    ...
    ;
    HistoryService.prototype.getRoomsHistoryUrl = function (userName) {
        var roomsHistoryUri = ROOMS_HISTORY_URI.replace("{userName}", userName);
...
HistoryService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [connection_service_1.ConnectionService, http_1.Http])
], HistoryService);
