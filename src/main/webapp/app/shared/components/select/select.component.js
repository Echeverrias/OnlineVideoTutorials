...
var select_html_1 = require("./select.html");
var SelectComponent = (function () {
    ...
    SelectComponent.prototype.onChange = function (value) {
...
], SelectComponent.prototype, "selectChange", void 0);
SelectComponent = __decorate([
    core_1.Component({
        moduleId: module.id,
        selector: 'ovt-select',
        template: select_html_1.selectTemplate,
