 ...
 */
 ...
 export class Participants{
    ...
    private _students22: string[];
    private _students2: Object;
   ...
   get students2(): Object{
        return this._students2;
    }
   
   get studentsNames2(): string[]{
        return Object.keys(this._students2);
    }
    ...
    addParticipant(user: User){
        ...
        if (user.isATutor()){
            this._tutor = user;
            console.log(`Tutor added: ${this._tutor}`)
        }
        else{
            console.log(`Participants.students before: ${JSON.stringify(this._students)}`);
             console.log(`user.userName: ${user.userName}`);
            this._students[user.userName] = user;
            console.log(`Participants.students after: ${JSON.stringify(this._students)}`);
        }
