...
import {Component, OnInit, ViewChildren, onDestroy} from 'angular2/core';
import {CORE_DIRECTIVES, AfterViewInit} from 'angular2/common';
...
export class RoomComponent implements onDestroy{
    ...
    private getParticipant (userName: string): ParticipantComponent{
        ...
        let participants = this.participants._results.filter(participant => participant.id === userName);
